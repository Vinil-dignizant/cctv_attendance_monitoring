...
class PostInstallCommand:
    ...
    def install_torch(self):
        ...
        subprocess.check_call([sys.executable, "-m", "pip", "install"] + torch_pkgs)
    ...
    def install_requirements(self):
        ...
        # Filter out torch/torchvision since we handle them separately
        requirements = [
            req for req in requirements 
            if not any(req.startswith(pkg) for pkg in ["torch", "torchvision"]
        ]
